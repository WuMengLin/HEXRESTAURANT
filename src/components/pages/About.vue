      ...
      <div class="container marketing mt-5">
        ...
        <div class="row pt-5 ">
          ...
          <div class="col-lg-4">
            ...
            <p><a class="btn btn-secondary text-light view-details-2" role="button">View details »</a></p>
          </div>
          <div class="col-lg-4">
            <div class="PopPhoto mb-4 " style="width:140px;height:140px;margin: 0 auto;">
            ...
            <p><a class="btn btn-secondary text-light view-details-3" role="button">View details »</a></p>
          </div>
        </div>
